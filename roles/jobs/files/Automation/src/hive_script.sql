...
Context_of_Research String) row format delimited fields terminated by ',' stored as textfile location '/hive_job_data/rsrch_data/2017' tblproperties ("skip.header.line.count"="1");
...
ClinicalTrials_Gov_Identifier String,	
Research_Information_Link String,	
Context_of_Research String) row format delimited fields terminated by ',' stored as textfile location '/hive_job_data/rsrch_data/2016' tblproperties ("skip.header.line.count"="1");
...
ClinicalTrials_Gov_Identifier String,	
Research_Information_Link String,	
Context_of_Research String) row format delimited fields terminated by ',' stored as textfile location '/hive_job_data/rsrch_data/2015' tblproperties ("skip.header.line.count"="1");
...
ClinicalTrials_Gov_Identifier String,	
Research_Information_Link String,	
Context_of_Research String) row format delimited fields terminated by ',' stored as textfile location '/hive_job_data/rsrch_data/2014' tblproperties ("skip.header.line.count"="1");
...
ClinicalTrials_Gov_Identifier String,	
Research_Information_Link String,	
Context_of_Research String) row format delimited fields terminated by ',' stored as textfile location '/hive_job_data/rsrch_data/2013' tblproperties ("skip.header.line.count"="1");
